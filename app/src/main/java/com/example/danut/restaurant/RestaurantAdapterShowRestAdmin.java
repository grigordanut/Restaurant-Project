...
public class RestaurantAdapterShowRestAdmin extends RecyclerView.Adapter<RestaurantAdapterShowRestAdmin.ImageViewHolder> {
    ...
    public RestaurantAdapterShowRestAdmin(Context restaurants_context, List<Restaurants> restaurants_uploads) {
