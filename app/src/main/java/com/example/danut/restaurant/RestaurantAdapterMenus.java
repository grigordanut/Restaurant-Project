...
public class RestaurantAdapterMenus extends RecyclerView.Adapter<RestaurantAdapterMenus.ImageViewHolder>{
    ...
    public RestaurantAdapterMenus(Context restaurants_context, List<Restaurants> restaurants_uploads){
